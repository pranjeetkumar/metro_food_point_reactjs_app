    ...
    <div className='w-screen h-screen relative overflow-hidden flex'>
        ...
        <div className='flex flex-col items-center bg-lightOverlay w-[80%] md:w-508 h-full z-10 backdrop-blur-sm p-4 px-4 py-12 gap-6'>
            ...
            <div className='flex items-center justify-start gap-4 w-full'>
                ...
                <p className='text-headingColor font-semibold text-2xl'>Welcome to</p>

            </div>
            {/* Welcome text */}
            <p className='text-3xl font-semibold text-headingColor'>Metro E. Vegetables & Food Points</p>
            ...
            <div className='w-full flex flex-col items-center justify-center gap-6 px-4 md:px-12 py-4'>
                ...
                {!isSignUp ? (
                <p>
                    Doesn't have an account : <motion.button {...buttonClick} className='text-primary underline cursor-pointer bg-transparent'onClick={() => setIsSignUp(true)}>Create One</motion.button>
                </p> 
                ) : (
                <p>
                    Already have an account : <motion.button {...buttonClick} className='text-primary underline cursor-pointer bg-transparent' onClick={() => setIsSignUp(false)}>Sign in</motion.button>
                </p> 
                )}
                {/* button section */}
                {isSignUp ? (
